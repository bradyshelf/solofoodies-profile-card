  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-white shadow-lg rounded-2xl overflow-hidden">
      <CardContent className="p-0">
          ...
          <div className="ml-4 flex-1">
            <div className="flex justify-between items-center space-x-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs font-semibold text-gray-900">{instagram.followers}</div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs font-semibold text-gray-900">{tiktok.followers}</div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs font-semibold text-gray-900">{youtube.followers}</div>
        ...
        {/* Profile Information Section at Bottom */}
